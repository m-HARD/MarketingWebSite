        ...
        <div class="mx-20 flex justify-center">
            <div class="mb-3 bg-gray-300 rounded-lg overflow-hidden w-2/3">
                ...
                <div class="py-1 px-5">
                    ...
                    <span v-else><input type="text" name="name" id="name" v-model="product.name"></span>
                </div>
                <div class="py-1 px-5 flex flex-wrap">
                    ...
                    <span v-else><textarea name="description" id="description" cols="82" rows="3" v-model="product.description"></textarea></span>
                </div>
                <div class="py-1 px-5">
                    <span class="font-bold">Price : </span>
                    <span v-if="editing == false">{{ product.price | currency }}</span>
                    <span v-else><input type="number" name="price" id="price" v-model="product.price"></span>
                </div>
                <div class="py-1 px-5">
                    <span class="font-bold">In Stock : </span>
                    <span v-if="editing == false">{{ product.inStock }}</span>
                    <span v-else><input type="number" name="inStock" id="inStock" v-model="product.inStock"></span>
                </div>
                <div class="py-1 px-5">
                ...
                <div class="pb-4 px-5 text-right">
                    ...
                    <div v-else>
                        <a href="#" class="px-3 py-2 bg-green-600 hover:bg-green-800 rounded-md text-gray-300" @click="updateProduct()">Update</a>
